...
//244167/1653077/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "STMPS2151TTR" (originalName "STMPS2151TTR")
	...
	(compDef "STMPS2151TTR" (originalName "STMPS2151TTR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "IN_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "IN_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "EN") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "OUT_3") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "OUT_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "OUT_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "FAULT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "STMPS2151TTR"))
		...
		(attr "Manufacturer_Part_Number" "STMPS2151TTR")
		(attr "Mouser Part Number" "511-STMPS2151TTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/STMPS2151TTR?qs=qolwYojYp3TtdEE8TCWfkg%3D%3D")
		(attr "Arrow Part Number" "STMPS2151TTR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/stmps2151ttr/stmicroelectronics")
		(attr "Description" "Power Switch ICs - Power Distribution SGL CHNL PWR SWTCH")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/stmps2141.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "STMPS2151TTR.stp")
