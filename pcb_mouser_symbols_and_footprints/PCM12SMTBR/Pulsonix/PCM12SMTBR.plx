...
(library Library_1
	...
	(patternDef "PCM12SMTBR" (originalName "PCM12SMTBR")
		(multiLayer
			...
			(pad (padNum 6) (padStyleRef r100_80) (pt -3.650, 0.965) (rotation 0))
			(pad (padNum 7) (padStyleRef r100_80) (pt 3.650, 0.965) (rotation 0))
			(pad (padNum 8) (padStyleRef r100_80) (pt -3.650, -0.965) (rotation 0))
			(pad (padNum 9) (padStyleRef r100_80) (pt 3.650, -0.965) (rotation 0))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, -0.150) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.35 1.3) (pt 3.65 1.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.65 1.3) (pt 3.65 -1.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.65 -1.3) (pt -3.35 -1.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.35 -1.3) (pt -3.35 1.3) (width 0.025))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -5.05 3.5) (pt 5.05 3.5) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 5.05 3.5) (pt 5.05 -3.8) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 5.05 -3.8) (pt -5.05 -3.8) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -5.05 -3.8) (pt -5.05 3.5) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 -1.3) (pt 0 -2.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 -2.8) (pt 1.3 -2.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.3 -2.8) (pt 1.3 -1.3) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 2.8 -1.3) (pt -2.8 -1.3) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 1.3 -1.3) (pt 1.3 -2.8) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 1.3 -2.8) (pt 0 -2.8) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -2.8) (pt 0 -1.3) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.2 1.3) (pt -1.4 1.3) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.25 3.05) (pt -2.25 3.05) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -2.25, 3) (radius 0.05) (startAngle 90.0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.25 2.95) (pt -2.25 2.95) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -2.25, 3) (radius 0.05) (startAngle 270) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "PCM12SMTBR" (originalName "PCM12SMTBR")
	...
	(compDef "PCM12SMTBR" (originalName "PCM12SMTBR") (compHeader (numPins 7) (numParts 1) (refDesPrefix S)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PCM12SMTBR"))
		(attachedPattern (patternNum 1) (patternName "PCM12SMTBR")
			(numPads 7)
			(padPinMap
		...
		(attr "Mouser Part Number" "611-PCM12SMTBR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/CK/PCM12SMTBR?qs=By6Nw2ByBD1OEOnWcdZb2g%3D%3D")
		(attr "Manufacturer_Name" "C & K COMPONENTS")
		(attr "Manufacturer_Part_Number" "PCM12SMTBR")
		(attr "Description" "Slide Switch SPDT Surface Mount, Right Angle")
		(attr "<Hyperlink>" "https://www.ckswitches.com/media/1424/pcm.pdf")
		(attr "<Component Height>" "1.4")
		(attr "<STEP Filename>" "PCM12SMTBR.stp")
		(attr "<STEP Offsets>" "X=0;Y=-0.03;Z=0.03")
