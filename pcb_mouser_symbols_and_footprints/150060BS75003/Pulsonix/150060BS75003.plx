...
(library Library_1
	...
	(patternDef "150060BS75003" (originalName "150060BS75003")
		(multiLayer
		...
		(layerContents (layerNumRef 28)
			(line (pt 0.8 0.4) (pt 0.8 -0.47) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.8 -0.47) (pt -0.8 -0.47) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.8 -0.47) (pt -0.8 0.4) (width 0.025))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.2 1.4) (pt 2.2 1.4) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 2.2 1.4) (pt 2.2 -1.47) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 2.2 -1.47) (pt -2.2 -1.47) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.2 -1.47) (pt -2.2 1.4) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "150060BS75003" (originalName "150060BS75003")
	...
	(compDef "150060BS75003" (originalName "150060BS75003") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "150060BS75003"))
		(attachedPattern (patternNum 1) (patternName "150060BS75003")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "710-150060BS75003")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Wurth-Elektronik/150060BS75003?qs=Li%252BoUPsLEnu8LvIbM48DKA%3D%3D")
		(attr "Manufacturer_Name" "Wurth Elektronik")
		(attr "Manufacturer_Part_Number" "150060BS75003")
		(attr "Description" "SMT Mono-Color Chip LED Waterclear Advance SMT 0603 Blue Typ.(@20mA): 350mcd 3,2V 140  Advance")
		(attr "<Hyperlink>" "https://www.we-online.com/catalog/datasheet/150060BS75003.pdf")
		(attr "<Component Height>" "0.7")
		(attr "<STEP Filename>" "150060BS75003.stp")
