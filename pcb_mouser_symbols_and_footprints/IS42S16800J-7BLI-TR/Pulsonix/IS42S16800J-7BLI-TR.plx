...
(library Library_1
	...
	(symbolDef "IS42S16800J-7BLI-TR" (originalName "IS42S16800J-7BLI-TR")
	...
	(compDef "IS42S16800J-7BLI-TR" (originalName "IS42S16800J-7BLI-TR") (compHeader (numPins 54) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IS42S16800J-7BLI-TR"))
		...
		(attr "Manufacturer_Part_Number" "IS42S16800J-7BLI-TR")
		(attr "Description" "DRAM 128M, 3.3V, SDRAM, 8Mx16, 143Mhz, 54 ball BGA (8mmx8mm) ROHS, IT, T&R")
		(attr "<Hyperlink>" "https://www.mouser.be/datasheet/2/198/42_45S81600J_16800J-3460583.pdf")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "IS42S16800J-7BLI-TR.stp")
